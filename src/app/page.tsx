        ...
        <div className="flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            >
              ...
              <p className="text-gray-300">
                Generate a QR code for your wallet address to receive payments
                in USDC
              </p>
            </Link>
          ...
          <div className="mt-12 rounded-lg bg-blue-900/20 p-4 text-center text-sm text-blue-200">
            <p>
              ...
              selected token is automatically swapped to USDC using
              Jupiter&apos;s powerful swap engine. Recipients always receive
              USDC, regardless of which token you pay with.
            </p>
          </div>
        </div>
      </main>
